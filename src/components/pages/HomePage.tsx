...
const HomePage = () => (
    <Container maxWidth="md" style={styles.Container}>
        ...
        <Row style={styles.authorSection}>
            <Col md={6}>
                <Image src={photo} width={photoWidth} height={photoHeight} style={styles.photo}/>
            </Col>
            <Col md={6} style={styles.centerText}>
                <p>
        ...
        <Row>
            ...
            <Col md={3}>
                <div style={styles.productGroup}>
                    ...
                    <p style={styles.tightText}>
                        {bullet} <Link style={styles.link} href={COACHING_PAYMENT_LINK}>Coaching</Link>
                    </p>
                    <p style={styles.tightText}>
                        {bullet} <Link style={styles.link} href={EBOOK_LINK}>Free eBook</Link>
                    </p>
                    <p style={styles.tightText}>
                        {bullet} <Link style={styles.link} href={SELF_LED_ONLINE_COURSE_LINK}>Paid
                        eBook</Link>
                    </p>
                    <p style={styles.tightText}>
                        {bullet} <Link style={styles.link} href={PODCAST_SUBSCRIPTION_LINK}>Podcast
                        Subscription</Link>
                    </p>
                </div>
            </Col>
